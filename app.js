...
var DB_HOST     = process.env.MONGO_HOST || "localhost"
var DB_USER     = process.env.MONGO_USER || "user"
var DB_PASSWORD = process.env.MONGO_PASSWORD || "pass"
var DB_NAME     = process.env.MONGO_NAME || "todo"
var DB_URL      = `mongodb://${DB_USER}:${DB_PASSWORD}@${DB_HOST}:27017/${DB_NAME}`
